...
class Device private constructor(
    ...
    override fun toString(): String =
        "Device(type=$type, name='$name', vendor=$vendor, description='$description', version='$version', serial='$serial', location='$location', activeModeIndex=$activeModeIndex, modes=${modes.contentToString()}, zones=${zones.contentToString()}, leds=${leds.contentToString()}, colors=${colors.contentToString()}, activeMode=$activeMode, colorSetter=$colorSetter)"
}